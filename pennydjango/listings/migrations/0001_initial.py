    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_fee_listing', models.BooleanField(default=False, help_text='Only check if OP is 100%')),
                ('utilities', models.CharField(max_length=255)),
                ('agent_notes', models.TextField(blank=True, max_length=250)),
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('approved', 'Approved'), ('not_approved', 'Not Approved')], default='draft', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='listings.Listing')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('landlord_contact', models.CharField(blank=True, max_length=150, verbose_name='Landlord Contact (Private)')),
                ('building_access', models.TextField(blank=True, max_length=255, verbose_name='Building Access (Private)')),
