...
class MapPanel extends React.Component {
    render() {
        return (
            <iframe src={`https://maps.google.com/maps?q=${this.props.initial_address}&t=&z=13&ie=UTF8&iwloc=&output=embed`}
...
class ListingsPanel extends React.Component {
    render(){
        ...
        return (
            <div class="row main-content-row">
              <div class="col-md-6 main-scroll">
                <ListingsPanel listings={this.props.listings}/>
              </div>
              <div class="col-md-6 p-0 map-panel">
                <MapPanel initial_address={this.props.listings[0].address}/>
              </div>
            </div>
        )
    }
